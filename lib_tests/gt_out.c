...
void _std_lib_default(standard_library_context* ctx){
 ...
 lib_global_context.heap_management_enabled = 0;
...
void _std_lib_managed(standard_library_context* ctx){
 ...
 ctx->logger = int_std_logger;
 ctx->operation_failure = int_operation_failure;
 lib_global_context.heap_management_enabled = 1;
...
# 24 "../lib/global/environment.h" 2
# 87 "../lib/foundation.h" 2
...
_Bool _string_char_at(string*, long, utf8_char*);
...
# 99 "../lib/types/string/string.h" 2
...
_Bool _string_char_at(string* str, long pos, utf8_char* unichar){
...
# 100 "../lib/types/string/string.h" 2
# 36 "../lib/string.h" 2
# 34 "../lib/map.h" 2
...
void main(){
 ...
 size_t dat = (size_t)_std_malloc(230);
